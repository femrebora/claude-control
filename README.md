...
<p align="center">
  <img src="assets/claude-control-icon.svg" width="220" alt="claude-control icon" />
</p>

<h1 align="center">claude-control</h1>

<p align="center">
  A small local dashboard for managing your Claude Code skills, plugins, agents, and commands.
</p>
